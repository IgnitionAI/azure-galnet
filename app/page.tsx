...
import { startGalnetChat, continueGalnetChat, GalnetApiError } from "@/lib/galnet-api"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { ScrollArea } from "@/components/ui/scroll-area"
import { Send, Zap, Radio, Settings, HelpCircle, ExternalLink } from "lucide-react"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-orange-600">Elite Dangerous Command Interface</p>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex space-x-4">
              ...
              <Button
                ...
                className="bg-orange-500 hover:bg-orange-600 text-black font-semibold px-6 disabled:opacity-50 disabled:cursor-not-allowed"
              >
